...
export function Footer() {
  return (
    <footer className="bg-background/80 border-t border-border backdrop-blur-sm py-16">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          {/* Brand */}
          <div>
            <div className="text-2xl font-serif font-bold mb-4 text-foreground">Luxe Studio</div>
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">© 2025 Luxe Studio. All rights reserved.</p>
